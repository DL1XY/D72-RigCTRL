...
class TestBCSet(unittest.TestCase):
    ...
    def test_exception(self):
        ...
        self.assertEqual(
            ...
            f"Band {NegativeTest.MINUS_ONE} outside valid range, should be 0 or 1"
        ) 